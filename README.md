...
1. Data Preparation : Cleaned raw IPL Player data and seperated batter and bolwer performance records
...
```bash
git clone https://github.com/vrunstar/ipl_fantasy_prediction.git
cd ipl
```
